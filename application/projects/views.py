...
def projects_view(project_id):
    ...
    if project.account_id == current_user.id:
        ...
        return render_template("projects/view.html", project = project, tasks = tasks, categories = categories)
    else:
        return redirect(url_for("projects_list"))
...
def tasks_form(project_id, category_id):
    ...
    if project.account_id == current_user.id and category.project_id == project.id:
